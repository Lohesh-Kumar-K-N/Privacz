...
code = code.replace(/window\.addEventListener\('DOMContentLoaded', \(\) => \{\n\/\/ ============================================================================/, hashLogic + "\n// ============================================================================");

// In case the above replace didn't work because of \r\n or something:
if (code.includes("window.addEventListener('DOMContentLoaded', () => {\n// ============================================================================")) {
   code = code.replace("window.addEventListener('DOMContentLoaded', () => {\n// ============================================================================", hashLogic + "\n// ============================================================================");
} else if (code.includes("window.addEventListener('DOMContentLoaded', () => {\r\n// ============================================================================")) {
   code = code.replace("window.addEventListener('DOMContentLoaded', () => {\r\n// ============================================================================", hashLogic + "\n// ============================================================================");
}
